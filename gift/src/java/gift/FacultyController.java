...
public class FacultyController implements Serializable {
    ...
    @EJB
    private gift.FacultyFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("re/Bundle").getString("FacultyCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("re/Bundle").getString("FacultyUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("re/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("re/Bundle").getString("FacultyDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("re/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Faculty getFaculty(java.lang.Integer id) {
